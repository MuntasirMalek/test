...
### Major Release
- **V2 Stability**: This major release cements the "Nuclear Sync + Timestamp Gate" architecture as the standard.
- **Simplified Logic**: Removed all experimental scrolling algorithms (Percentage, Hybrid, Proximity) in favor of the battle-tested v1.0.51 logic.
- **Performance**: Retains the 50ms throttle for smooth performance.

## [1.0.55] - 2024-01-26

### Fixed
- **REVERTED to v1.0.51**: As requested, I have reverted all "smart" logic (Percentage Fallback, Hybrid Scroll, Proximity Checks). 
- **State**: This version is a bit-for-bit copy of v1.0.51 logic. It has Nuclear Sync (Left) and Timestamp Gate (Right).
